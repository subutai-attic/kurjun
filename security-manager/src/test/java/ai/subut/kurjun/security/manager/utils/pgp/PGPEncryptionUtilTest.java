...
public class PGPEncryptionUtilTest
{
    ...
    @Mock
    PGPOnePassSignatureList signatures;
    ...
    public void testMessageSigning() throws Exception
    {
        ...
        byte[] encryptedMessage = PGPEncryptionUtil
                .encrypt( "Time is the most luxurious thing we have.".getBytes(), pgpKeyring.getPublicKey(), true );
