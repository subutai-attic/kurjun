    ...
    <div class="b-form__wrapper g-margin-bottom-half">
      <form method="post" action="${contextPath}/users/create">
        <div class="b-workspace__content">
          <div class="b-form__wrapper g-margin-bottom-half">
            <label class="b-form-label">Username</label>
            <input type="text" name="username" class="b-form-input " />
          </div>
          <div class="b-form__wrapper g-margin-bottom-half">
            <label class="b-form-label">User Public Key</label>
            <textarea name="key" class="b-form-input b-form-input_full bp-set-pub-key"
                      style="width: 370px; height: 160px"></textarea>
          </div>
        </div>
