...
public interface RepositoryFactory
{
    ...
    @Named( PackageType.RAW )
    RemoteRawRepository createNonLocalRaw( @Assisted( "url" ) String url, @Nullable User identity, String search );
     ...
     */
    @Named( PackageType.DEB )
    RemoteRepository createNonLocalApt( URL url, String search );
