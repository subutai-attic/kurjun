...
import ai.subut.kurjun.metadata.storage.nosql.ServiceConstants;
import ai.subut.kurjun.model.metadata.PackageMetadataStore;


public class NoSqlStoreActivator implements BundleActivator, ManagedService
{
    private static final Logger LOGGER = LoggerFactory.getLogger( NoSqlStoreActivator.class );
